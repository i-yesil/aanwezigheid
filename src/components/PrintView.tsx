    ...
    <div className="hidden print:block text-black p-4 space-y-6">
      <div className="border-b-2 border-black pb-3">
        <h1 className="text-xl font-bold uppercase tracking-wider">
          Werken aan Aanwezigheidsethos · Hogeschool Rotterdam
        </h1>
        ...
        <p className="text-[11px] text-neutral-600 mt-1 italic">
          Aanwezigheid is een wicked problem: veel actoren, veel factoren, en beleidskeuzes die elkaar beïnvloeden. Er is geen één magische oplossing. Wat wel werkt: zorgen dat de keuzes die je maakt op elkaar zijn afgestemd; binnen het team en tussen de feitelijke en normatieve dimensies.
        </p>
      </div>
        ...
        <div>
          ...
          <ul className="text-[10px] space-y-1 text-neutral-800 pl-4 list-disc">
            {jurisprudentieSources.map((s) => (
              <li key={s.id}>
                <strong>{s.title}</strong> ({s.year}) — {s.summary}
              </li>
            ))}
          </ul>
        </div>
